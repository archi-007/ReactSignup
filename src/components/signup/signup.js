...
class Signup extends Component
{
    ...
    validatePassword=(e)=>{
        ...
        const checkLength=new RegExp("^(?=.{10,}$)")
        ...
        this.setState({...this.state,passValidation:"Password should have atleast 10 characters"})
        else if(!checkUpperCase.test(password))
        this.setState({...this.state,passValidation:"Password should have atleast one upper case character"})
        else if(!checkLowerCase.test(password))
        this.setState({...this.state,passValidation:"Password should have atleast one lower case character"})
        else if(!checkDigit.test(password))
        this.setState({...this.state,passValidation:"Password should have atleast one digit"})
        else if(!checkSpecialChar.test(password))
        this.setState({...this.state,passValidation:"Password should have atleast one special character"})
        else   
        {
            this.setState({...this.state,passValidation:"Validated",password:password})   
        }  
    }
    handleSubmit=(e)=>{
        e.preventDefault();
            ...
            <div className="row">
                ...
                <div className="col-md-6 col-sm-8 mid" style={{justifyContent:"center", textAlign:"center"}}>
                    ...
                    <div style={{display:"block"}}>              
                        <button type="submit" className="signup btn btn-primary">Sign Up</button>
                        {/* link to login page */}
